<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :row-key="getRowKey" @row-click="clickRow" ref="table" @selection-change="handleSelectionChange" :data="roles.slice((pageNum-1)*pageSize,pageNum*pageSize)">
      ...
      <el-table-column label="The name of the role" align="center" prop="roleName" />
      <el-table-column label="Permission characters" align="center" prop="roleKey" />
      <el-table-column label="creattime" align="center" prop="createTime" width="180">
        <template slot-scope="scope">
    ...
    <el-form label-width="100px">
      <el-form-item style="text-align: center;margin-left:-120px;margin-top:30px;">
        ...
        <el-button @click="close()">comeback</el-button>
      </el-form-item>
    </el-form>
  </div>
</template>
  ...
  methods: {
    ...
    submitForm() {
      ...
      updateAuthRole({ userId: userId, roleIds: roleIds }).then((response) => {
        this.$modal.msgSuccess("Authorization is successful");
        this.close();
      });
    },
    /** 关闭按钮 */
