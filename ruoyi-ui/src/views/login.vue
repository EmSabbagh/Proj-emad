<template>
  <div class="login">
    <el-form ref="loginForm" :model="loginForm" :rules="loginRules" class="login-form">
      <h3 class="title">Culture Network</h3>
      ...
      <el-form-item style="width:100%;">
        ...
        <div style="float: right;" v-if="register">
          <router-link class="link-type" :to="'/register'">enroll</router-link>
        </div>
      </el-form-item>
    </el-form>
    <!--  底部  -->
  ...
  data() {
    return {
      ...
      loginRules: {
        ...
        code: [{ required: true, trigger: "change", message: "Please enter a verification code" }]
      },
      loading: false,
      // 验证码开关
      captchaEnabled: true,
